...
//        textLayer?.alignmentMode = "center""center"
        ...
        rightProgressView.backgroundColor = .blue
...
//        rightProgressView.topAnchor.constraint(equalTo: margin.topAnchor).isActive = true
        rightProgressView.topAnchor.constraint(equalTo: topAnchor).isActive = true
        ...
        leftProgressView.backgroundColor = .blue
